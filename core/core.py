...
class ConvoAI:
    def __init__(self, data_file="data.yaml"):
        ...
        self.conversation_history = os.path.join(core_directory, "_conversation", "conversation.json")
        self.prompts_history = os.path.join(core_directory, "_conversation", "prompts.txt")
    ...
    def save_conversation(self):
        entry = {'time': time.ctime(), 'input': self.current_input, 'response':self.response}
